    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            .invoice-header { padding: 0 0 10px 0; }
            .invoice-info-section { padding: 10px 0; }
            .summary-section { padding: 10px 0; }
            .invoice-table th, .invoice-table td { padding: 6px; }
            .signature-section { margin-top: 12px; padding: 20px 0 10px 0; }
...
<div class="no-print" style="position: fixed; top: 10px; right: 10px; z-index: 9999;">
    <a href="{{ url('/all-local-sale') }}" class="action-btn" style="display: inline-block;">&larr; Back</a>
</div>
...
<div class="invoice-preview-shell">
    ...
    <div class="invoice-header">
        ...
        <div class="invoice-title" style="text-align: right; display: flex; flex-direction: column; align-items: flex-end;">
            <h2 style="font-size: 26px; font-weight: 900; margin: 0 0 8px 0; letter-spacing: 0.5px; color: #000; line-height: 1;">
