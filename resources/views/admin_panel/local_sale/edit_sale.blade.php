                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control readonly-box" value="{{ ucfirst($original->party_type) }}"
                                    readonly>
                            </div>

                            <div class="col-md-3">
                                <label>Customer</label>
                                <input class="form-control readonly-box" value="{{ $original->customer_shopname }}"
                                    readonly>
                            ...
                            <div class="col-md-3">
                                <label>Phone</label>
                                <input class="form-control readonly-box" value="{{ $original->customer_phone }}"
                                    readonly>
                            </div>

                            <div class="col-md-3">
                                <label>Address</label>
                                <input class="form-control readonly-box" value="{{ $original->customer_address }}"
                                    readonly>
                            </div>
                                ...
                                <tbody id="saleTableBody">
                                    ...
                                    @foreach($items as $i => $item)
                                        <tr class="sale-row">
                                            ...
                                            <td>
                                                <input name="item[]" class="form-control readonly-box" value="{{ $item }}"
                                                    readonly>
                                            </td>
                                            ...
                                            <td>
                                                <select name="unit[]" class="form-control unit">
                                                    <option value="ft" {{ ($units[$i] ?? '') == 'ft' ? 'selected' : '' }}>Feet
                                                    </option>
                                                    <option value="inch" {{ ($units[$i] ?? '') == 'inch' ? 'selected' : '' }}>
                                                        Inch
                                                    </option>
                                                </select>
                                            </td>
