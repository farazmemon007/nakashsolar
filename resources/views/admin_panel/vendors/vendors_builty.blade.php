                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editVendorModal{{ $builty->id }}">
                                                Edit
                                            </button>

                                            @foreach($builtyRecords as $builty)
                                                <!-- Edit Vendor Builty Modal -->
                                                <div class="modal fade" id="editVendorModal{{ $builty->id }}" tabindex="-1"
                                                    aria-labelledby="editVendorModalLabel{{ $builty->id }}" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="{{ route('update-vendors-builty', $builty->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="date" name="date"
                                                                            value="{{ $builty->date }}" class="form-control"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="month" name="month"
                                                                            value="{{ \Carbon\Carbon::parse($builty->month)->format('Y-m') }}"
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="number" name="amount"
                                                                            value="{{ $builty->amount }}" class="form-control"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <textarea name="description" class="form-control"
                                                                            rows="2">{{ $builty->description }}</textarea>
                                                                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="vendor_id" class="form-control" required>
                            <option value="">-- Select Vendor --</option>
                            @foreach($Vendors as $vendor)
                                <option value="{{ $vendor->id }}|{{ $vendor->Party_name }}">{{ $vendor->Party_name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
