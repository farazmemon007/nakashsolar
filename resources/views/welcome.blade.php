...
<head>
    ...
    <title>Welcome - {{ $appSettings['company_name'] }} Software</title>
...
<body>
    ...
    <section class="hero">
        ...
        <div class="glass-card">
            ...
            <!-- Title -->
            <h1 class="title">
                Welcome to <span class="title-accent">{{ $appSettings['company_name'] }}</span> Software
            </h1>
        ...
        <!-- Footer -->
        <p class="footer-text">© {{ date('Y') }} {{ $appSettings['company_name'] }} Software. All rights reserved.</p>
